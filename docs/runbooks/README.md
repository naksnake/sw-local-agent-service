...
| [`setup-and-operations-sop.md`](setup-and-operations-sop.md) · [中文](setup-and-operations-sop.zh-Hant.md) | — | The operator SOP, English and Traditional Chinese together (INV-13): what runs today and what waits, roles, prerequisites, the build-host and platform-host procedures with a done-when per step, daily operation, models, backups and restore, development mode, troubleshooting. |

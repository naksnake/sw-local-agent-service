...
| `../../images/screen-worker/Dockerfile` | Debian slim pinned by digest with xvfb, x11vnc, novnc, websockify, xdotool, imagemagick; non-root user. Lives under `images/` with every other first-party image and is built from the repository root (`images/README.md`) |
